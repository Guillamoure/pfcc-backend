Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get 'klass_features/:id/options', to: 'klasses#klass_feature_options'
      ...
      patch 'character_klass_archetype_feature_usages', to: 'klass_features#klass_archetype_usage_update'

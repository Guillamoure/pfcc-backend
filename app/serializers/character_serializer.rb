class CharacterSerializer < ActiveModel::Serializer
  ...
  def character_creatures
    self.object.character_creatures.map do |cc|
      {
        feature_id: cc.feature_id,
        relationship: cc.relationship,
        creature: CreatureSerializer.new(cc.creature)
      }
    end
  end

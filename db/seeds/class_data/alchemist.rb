...
ClassSkillsetSkill.create!(klass_id: alchemist.id, skillset_id: cr.id, skill_id: Skill.find_by!(name: "Knowledge").id)
...
ClassSkillsetSkill.create!(klass_id: alchemist.id, skillset_id: ravnica_custom.id, skill_id: Skill.find_by!(name: "Knowledge").id)

...
A cleric must be able to present her holy symbol to use this ability.")
  ...
  cleric4_feature = Feature.create!(action_id: standard.id)
    ...
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 2, applicable_level: 3)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 3, applicable_level: 5)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 4, applicable_level: 7)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 5, applicable_level: 9)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 6, applicable_level: 11)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 7, applicable_level: 13)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 8, applicable_level: 15)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 9, applicable_level: 17)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice_increase: 10, applicable_level: 19)

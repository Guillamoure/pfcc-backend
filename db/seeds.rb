...
A cleric must be able to present her holy symbol to use this ability.")
  ...
  cleric4_feature = Feature.create!(action_id: standard.id)
    ...
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 2, damage_dice: 6, applicable_level: 3)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 3, damage_dice: 6, applicable_level: 5)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 4, damage_dice: 6, applicable_level: 7)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 5, damage_dice: 6, applicable_level: 9)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 6, damage_dice: 6, applicable_level: 11)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 7, damage_dice: 6, applicable_level: 13)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 8, damage_dice: 6, applicable_level: 15)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 9, damage_dice: 6, applicable_level: 17)
    FeatureDamage.create!(feature_id: cleric4_feature.id, num_of_dice: 10, damage_dice: 6, applicable_level: 19)
...
Each round, you can turn to detect evil in a new area. The spell can penetrate barriers, but 1 foot of stone, 1 inch of common metal, a thin sheet of lead, or 3 feet of wood or dirt blocks it.", target: "cone-shaped emanation", saving_throw: "none", spell_resistance: false, action_id: standard.id, spell_range_id: sixty_feet.id, magic_school_id: divination.id, duration: "concentration, up to 10 min./ level", time: 10, unit_of_time: "minute", increase_per_level: 10, dismissible: false, concentration: true)
  ...
  KlassFeatureAssociatedSpell.create!(klass_feature_id: cleric2.id, spell_id: sp128.id)
...
PreparedSpell.create!(spell_list_spell_id: stabilize_cleric.id, character_id: test_character.id, spell_level: 0, cast: false, feature_spellcasting_id: cleric_spellcasting.id)
